package Tc_traveler.thaumcraftrecipes.research;
...
public class myResearch {
    public static void addResearch(){
        ...
        (new ResearchItem("DESCRIPTION","SYNTHESIS",new AspectList()
                .add(Aspect.EXCHANGE,4)
                .add(Aspect.CRAFT,4)
                ,0,0,7,new ResourceLocation("thaumcraft","textures/aspects/_unknown.png")))
                .setSpecial()
                .setPages(new ResearchPage[]{new ResearchPage("tr.research.description_1")})
                .setLost()
                .setAspectTriggers(Aspect.CRAFT)
                .registerResearchItem();
        (new ResearchItem("ADDGREATWOOD","SYNTHESIS",new AspectList()
                .add(Aspect.PLANT,4)
                .add(Aspect.TREE,6)
                .add(Aspect.CRAFT,8)
                .add(Aspect.MAGIC,4)
        ...
        (new ResearchItem("ADDMANABEAN","SYNTHESIS",new AspectList()
                .add(Aspect.PLANT,4)
                .add(Aspect.CRAFT,4)
                .add(Aspect.MAGIC,4),4,0,1,new ItemStack(ConfigItems.itemManaBean)))
