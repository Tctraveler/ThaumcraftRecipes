...
public class ThaumcraftRecipesRecipe {
    public static void addRecipes(){
        ConfigResearch.recipes.put("trgreatwoodsapling",ThaumcraftApi.addCrucibleRecipe("ADDGREATWOOD",new ItemStack(GameRegistry.findItem("Thaumcraft","blockCustomPlant"),1,0),new ItemStack(Blocks.sapling,1,1),(new AspectList()).add(Aspect.PLANT,4).add(Aspect.TREE,4).add(Aspect.CRAFT,4)));
        ConfigResearch.recipes.put("trsilverwoodsapling",ThaumcraftApi.addInfusionCraftingRecipe("ADDSILVERWOOD",new ItemStack(ConfigBlocks.blockCustomPlant,1,1),12,(new AspectList()).add(Aspect.PLANT,16).add(Aspect.TREE,16).add(Aspect.ORDER,32).add(Aspect.MAGIC,32).add(Aspect.CRAFT,32),new ItemStack(ConfigBlocks.blockCustomPlant,1,0),new ItemStack[]{new ItemStack(ConfigBlocks.blockMagicalLog,1,1),new ItemStack(ConfigBlocks.blockMagicalLog,1,1),new ItemStack(ConfigBlocks.blockCustomPlant,1,2),new ItemStack(ConfigItems.itemShard,1,6),new ItemStack(ConfigItems.itemShard,1,6)}));
